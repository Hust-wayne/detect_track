...
class IOUTracker(object):
    ...
    def _return_box_id(self, bbox, iou_threshold=0.5):
        flag_match = False
        id_bbox = None
    ...
    def _check_IOU(self, detection):
        ...
        for id, bbox in enumerate(detection):
            flag_match, id_bbox = self._return_box_id(bbox)
    ...
    def check_coordinate(self, detection):
        for bbox in detection:
    ...
    def track_objects(self, detection, mode_input_coord='xmax_ymax'):
        ...
        detection = self.check_coordinate(detection)
